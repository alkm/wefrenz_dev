...
var ChatComponent = (function () {
    ...
    ChatComponent.prototype.openChatSocket = function (easyrtcId) {
        ...
        this.socket = __WEBPACK_IMPORTED_MODULE_2__libs_socket_io__('https://www.wefrenz.com:3000/');
...
var AppSettingsService = (function () {
    ...
    AppSettingsService.API_ENDPOINT = function (environment) {
        switch (environment) {
            case "local":
                return "https://www.wefrenz.com:3000" + port;
...
var VideoPlayerComponent = (function () {
    ...
    VideoPlayerComponent.prototype.fileChangeEvent = function (event) {
        var self = this;
